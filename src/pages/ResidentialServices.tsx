...
const ResidentialServices = () => {
  ...
  const galleryImages = ['/lovable-uploads/9d9d135a-46de-45f2-a56e-475fb2ea549d.png', '/lovable-uploads/b537fe42-5df9-4844-a6a8-8107f61f8dc1.png', '/lovable-uploads/815b0289-c0cd-4126-ab28-0729a80552ac.png'];
  ...
  return <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="relative mb-16 overflow-hidden rounded-lg">
            <div className="h-[500px] relative">
              <div className="absolute inset-0 bg-center bg-cover transform transition-transform duration-7000 hover:scale-105" style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="grid grid-cols-1 gap-4 h-fit">
              {galleryImages.map((img, index) => <Card key={index} className="overflow-hidden cursor-pointer" onClick={() => openLightbox(img)}>
                  <CardContent className="p-0 relative group">
                    <img src={img} alt={`Residential Interior ${index + 1}`} className="w-full h-auto object-cover transition-transform duration-500 group-hover:scale-105" />
      ...
      {/* Lightbox */}
      {lightboxOpen && <div className="fixed inset-0 z-50 bg-black/90 flex items-center justify-center p-4" onClick={closeLightbox}>
          <div className="relative max-w-4xl max-h-[90vh]">
            <img src={selectedImage} alt="Enlarged view" className="max-w-full max-h-[90vh] object-contain" />
            <button className="absolute top-4 right-4 text-white bg-black/50 rounded-full p-2 hover:bg-black/70 transition-colors" onClick={closeLightbox}>
